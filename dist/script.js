...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.balcon_icons', '.balcon_icons img', '.big_img > img', 'do_image_more', 'inline-block');
...
var changeModalState = function changeModalState(state) {
  ...
  bindActionToElem('change', windowProfile, 'profile'); // windowForm.forEach((item ,i) => {
...
var forms = function forms(state) {
  ...
  Object(_checkNumbInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]'); // phoneInputs.forEach(item => {
